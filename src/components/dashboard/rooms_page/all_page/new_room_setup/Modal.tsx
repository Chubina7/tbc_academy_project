...
export default function Modal({ modalHandler }: Props) {
  return (
    <>
      <Backdrop />
      <AddNewRoomProvider>
        <BottomToTop className="fixed z-50 w-full h-full max-h-[95%] bottom-0 left-0 bg-[#FFFFFF] dark:bg-[#352F44] rounded-t-2xl | px-3 py-10 flex flex-col justify-start items-center gap-3">
